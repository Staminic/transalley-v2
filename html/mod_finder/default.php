...
$output = '<input type="text" name="q" id="mod-finder-searchword' . $module->id . '" class="search-query form-control" size="'
...
{
	$button = '<div class="input-group-append"><button class="btn btn-outline-secondary ' . $suffix . ' finder' . '" type="submit" title="' . JText::_('MOD_FINDER_SEARCH_BUTTON') . '"><i class="fas fa-search"></i>' . '</button></div>';
